...
[`v1.1.1` release](https://github.com/nuggocto/suzumushi/releases/tag/v1.1.1),
either in your browser or with:

```sh
curl -fLO \
  'https://github.com/nuggocto/suzumushi/releases/download/v1.1.1/{SHA256SUMS,suzumushi-v1.1.1-x86_64-unknown-linux-gnu.tar.xz}'
```
...
tar -xf suzumushi-v1.1.1-x86_64-unknown-linux-gnu.tar.xz
cd suzumushi-v1.1.1-x86_64-unknown-linux-gnu
...
Version `1.1.1` is the current stable release. Its tag-driven Linux archive is
